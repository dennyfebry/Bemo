...
if ($_POST) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $mail->MsgHTML("Hallo $fullName ,<br/><br/>Terimakasih telah mendaftar akun Bemo<br/>Silakan klik <a href='http://dennyfebrygo.com/bemo/adminbemo/index.php/email/test/$id'>di sini</a> untuk verifikasi akun anda");
