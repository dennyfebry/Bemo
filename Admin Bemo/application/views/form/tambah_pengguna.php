...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_content">
          <form role="form" action="<?php echo base_url(); ?>index.php/admin/simpan_pengguna" method="POST">
            <input type="hidden" class="form-control" name="id" value="">
            <input type="hidden" class="form-control" name="akses" value="user">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="merk_mobil" value="" placeholder="Merek Mobil">
            </div>
            <div class="form-group">
              <label>Model Mobil</label>
              <input type="text" class="form-control" name="model_mobil" value="" placeholder="Model Mobil">
            </div>
            <div class="form-group">
              <label>No Kendaraan</label>
              <input type="text" class="form-control" name="no_kendaraan" value="" placeholder="No Kendaraan">
            </div>
            <br>
